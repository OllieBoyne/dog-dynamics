...
def uniform_fall():
    ...
    # GET L0S
    L0s = {"front": 6.84e-4 * self.total_mass, "rear": 6.91e-4 * self.total_mass}
...
### TODO: MODIFY DYNAMICS SO EVERYTHING IS EQUATIONS, THEN RUN COV METHOD
### TODO: IMPROVE THE EQUATIONS FOR BODY CALCULATIONS, FIGURING OUT A WAY TO RECONCILE THE 4 POINTS TO ONE CYLINDER.