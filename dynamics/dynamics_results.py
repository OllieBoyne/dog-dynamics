from my_work.dynamics_new import *
from my_work.data_loader import C3DData, load_force_plate_data, ForcePlateData, SMALData, get_delay_between
...
# r = IDResults(**set_2_3r4_mocap, clip_length=clip_length, load = False)
# r = IDResults(**set_2_3r4_smal, clip_length=clip_length)
r = IDResults(**set_2_6r1_mocap, clip_length=clip_length)
# r = IDResults(**lab, clip_length=clip_length)
# r = IDResults(**gus, clip_length=clip_length)
# r = IDResults(**collie, clip_length=clip_length)

#
# r.view_knee_torque(j=1, print_vals=True)
