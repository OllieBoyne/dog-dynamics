...
from my_work.data_loader import SMALData, extract_npz, DataSources
...
class SMALRenderer():
    ...
    def __init__(self, src, freq = 30, crop = None, smooth = False):
        ...
        smalx.joint_rot[:, 0] *= 0  # rear-to-front rotation to 0 for now
...
class MultiviewRenderer(SMALRenderer):
    ...
    def plot_image(self, azim = 90, elev = 0, frame=2):
        ...
        # plt.show()
        plt.savefig(r"C:\Users\Ollie\Dropbox\Ollie\University\IIB\Project\Figures\image_processing\multiview fit\douglas_walk.png",
                    dpi = 300)
